...
import { CreateAdminUseCase } from "../../domain/adminDashboard/admin/interfaces/use-cases/create-admin-use-case";
import { GetAllAdminsUseCase } from "../../domain/adminDashboard/admin/interfaces/use-cases/get-all-admins-use-case";
import { GetAdminByIdUseCase } from "../../domain/adminDashboard/admin/interfaces/use-cases/get-admin-by-id-use-case";
import { DeleteAdminUseCase } from "../../domain/adminDashboard/admin/interfaces/use-cases/delete-admin-use-case";
import { UpdateAdminUseCase } from "../../domain/adminDashboard/admin/interfaces/use-cases/update-admin-use-case";
import {
  validateCreateAdmin,
  validateUpdateAdmin,
